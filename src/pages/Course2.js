                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col text-center">
                            <div className="mb-3 d-flex flex-column mt-3 align-items-center">
                                <label htmlFor="activity1" className="form-label">Activities (?%):</label>
                                <input type="number" className="form-control" id="activity1" placeholder="--" style={{ width: '150px' }} />
                            </div>
                        </div>
                        <div className="col text-center">
                            <div className="mb-3 d-flex flex-column mt-3 align-items-center">
                                <label htmlFor="activity2" className="form-label">Quizzes(?%):</label>
                    ...
                    <div className="col mt-3">
                        <div className="mb-3 d-flex flex-column">
                            <label htmlFor="activity2" className="form-label">Project Output(?%):</label>
